    ...
    <div class="col-12">
        ...
        <div class="email-rightbar">
            ...
            <div class="btn-toolbar" role="toolbar">
                <div class="btn-group">
                    <button type="button" class="btn btn-primary waves-light waves-effect"><i class="fas fa-inbox"></i>
                    </button>
                    <button type="button" class="btn btn-primary waves-light waves-effect">
                        <i class="fas fa-exclamation-circle"></i></button>
                    <button type="button" class="btn btn-primary waves-light waves-effect"><i class="fas fa-trash"></i>
                    </button>
                </div>
                <div class="btn-group ml-1">
                    <button type="button" class="btn btn-primary waves-light waves-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            ...
            <div class="card my-3">
                <ul class="message-list">
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-purple badge mr-2">Social</span>This Week's Top Stories &nbsp;–&nbsp;
                    ...
                    <li class="unread">
                        <div class="col-mail col-mail-1">
                            ...
                            <a href="">
                                ...
                                <span class="star-toggle fas fa-star text-warning"></span>
                            </a>
                        </div>
                        <div class="col-mail col-mail-2">
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-pink badge mr-2">Friends</span>Weekend on Revibe &nbsp;–&nbsp;
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-purple badge mr-2">Social</span>Task assigned: Clone ARP's website
                                &nbsp;–&nbsp;
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject">Hey man &nbsp;–&nbsp;
                                <span class="teaser">Nah man sorry i don't. Should i get it?</span>
                            </a>
                            <div class="date">Feb 23</div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject">You can now use your storage in Google
                                Drive &nbsp;–&nbsp;
                                <span class="teaser">Hey Nicklas Sandell! Thank you for purchasing extra storage space in Google Drive.</span>
                            </a>
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject">Train/Bus &nbsp;–&nbsp;
                                <span class="teaser">Yes ok, great! I'm not stuck in Stockholm anymore, we're making progress.</span>
                            </a>
            ...
            <div class="row mb-3">
                ...
                <div class="col-5">
                    <div class="btn-group float-right">
                        <button type="button" class="btn btn-sm btn-primary waves-effect mb-0">
