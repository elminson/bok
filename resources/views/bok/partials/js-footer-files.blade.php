...
<script src="{{ url('https://apexcharts.com/samples/assets/irregular-data-series.js') }}"></script>
<script src="{{ url('https://apexcharts.com/samples/assets/series1000.js') }}"></script>
<script src="{{ url('https://apexcharts.com/samples/assets/ohlc.js') }}"></script>
